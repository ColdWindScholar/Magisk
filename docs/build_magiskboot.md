...
- Install [Git](https://git-scm.com/), then clone this repository: `git clone https://github.com/dropout-zzz/Magisk --depth=1 --single-branch --no-tags --recursive --shallow-submodules`
